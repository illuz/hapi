...
const MarkdownLinkBehaviorContext = createContext<MarkdownLinkBehavior>('navigate')
...
export function MarkdownLinkBehaviorProvider(props: {
    ...
    return (
        <MarkdownLinkBehaviorContext.Provider value={props.behavior}>
            {props.children}
...
export function MarkdownAnchor(props: ComponentPropsWithoutRef<'a'>) {
    ...
    const rel = target === '_blank' ? (relProp ?? 'noreferrer') : relProp
