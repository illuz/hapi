export default {
  ...
  'sessions.muteSounds': 'Mute notification sounds',
  'sessions.unmuteSounds': 'Unmute notification sounds',
  ...
  'session.autoRetryOn': 'AUTO is on for all sessions. Capacity or overload failures continue automatically after 5 seconds.',
  'session.autoRetryOff': 'Turn on AUTO for all sessions to continue capacity or overload failures automatically after 5 seconds.',
  'session.autoRetryUpdateFailed': 'Failed to update AUTO',
  ...
  'settings.codexModels.title': 'Codex Models',
  'settings.codexModels.modelId': 'Model ID',
  'settings.codexModels.displayName': 'Display name',
  'settings.codexModels.displayNamePlaceholder': 'Optional',
  'settings.codexModels.reasoningEfforts': 'Reasoning efforts (optional)',
  'settings.codexModels.add': 'Add model',
  'settings.codexModels.saving': 'Saving…',
  'settings.codexModels.loading': 'Loading…',
  'settings.codexModels.empty': 'No custom models',
  'settings.codexModels.remove': 'Remove',
  'settings.codexModels.invalidId': 'Enter a model ID without spaces.',
  'settings.codexModels.loadFailed': 'Failed to load custom Codex models',
  'settings.codexModels.saveFailed': 'Failed to save custom Codex model',
  'settings.codexModels.removeFailed': 'Failed to remove custom Codex model',
