export default {
  ...
  'session.autoRetryOn': 'AUTO is on. Capacity or overload failures continue automatically after 5 seconds.',
  'session.autoRetryOff': 'Turn on AUTO to continue capacity or overload failures automatically after 5 seconds.',
