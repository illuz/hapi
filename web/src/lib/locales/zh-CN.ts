export default {
  ...
  'sessions.muteSounds': '静音通知声音',
  'sessions.unmuteSounds': '开启通知声音',
  ...
  'session.autoRetryOn': 'AUTO 已对全部会话开启：容量或过载错误重试结束后，等待 5 秒自动继续。',
  'session.autoRetryOff': '为全部会话开启 AUTO：容量或过载错误重试结束后，等待 5 秒自动继续。',
  'session.autoRetryUpdateFailed': 'AUTO 设置失败',
  ...
  'session.history.detail.openSession': '打开会话',
  'session.history.detail.opening': '检查中…',
  'session.history.detail.deleted': '对话已删除。',
  'session.history.detail.openFailed': '打开会话失败。',
  ...
  'composer.expand': '放大输入框',
  'composer.collapse': '收起输入框',
  'composer.expandTitle': '放大输入框',
  'composer.expandDescription': '长消息可以在这里更舒适地编辑；移动端会尽量占满屏幕。',
  'composer.resize': '调整输入框高度',
  'composer.resizeHint': '拖动拉高',
  'composer.rememberHeight': '会记住上次高度',
  ...
  'settings.codexModels.title': 'Codex 模型',
  'settings.codexModels.modelId': '模型 ID',
  'settings.codexModels.displayName': '显示名称',
  'settings.codexModels.displayNamePlaceholder': '可选',
  'settings.codexModels.reasoningEfforts': '推理强度（可选）',
  'settings.codexModels.add': '添加模型',
  'settings.codexModels.saving': '保存中…',
  'settings.codexModels.loading': '加载中…',
  'settings.codexModels.empty': '暂无自定义模型',
  'settings.codexModels.remove': '移除',
  'settings.codexModels.invalidId': '请输入不含空格的模型 ID。',
  'settings.codexModels.loadFailed': '加载自定义 Codex 模型失败',
  'settings.codexModels.saveFailed': '保存自定义 Codex 模型失败',
  'settings.codexModels.removeFailed': '移除自定义 Codex 模型失败',
